...
namespace mysheet
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            update_excel(indexPK,indexQty, product);
         }

        public static void update_excel(int primary, int qty, Dictionary<string, int> dict)
        {
            Microsoft.Office.Interop.Excel.Application excel = new Microsoft.Office.Interop.Excel.Application();
            Microsoft.Office.Interop.Excel.Workbook sheet = excel.Workbooks.Open("https://nnn-oms.herokuapp.com/Product_List/hangry%20neko%206.xlsm");
