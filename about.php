		...
		<div class="row my-3 py-3" style="border: 1px solid #E1E1E1;border-radius: 5px;background-color: white;">
			...
			<div class="col-lg-3 text-center my-4 ">
				<div class="card border-warning filter">
					...
					<div class="card-body">
						<h5>Location</h5>
						<a href="https://wego.here.com/directions/mix//Neko-Neko-Nyaa,-93350-Kuching,-Malaysia:e-?map=1.5178,110.36632,15,normal&fb_locale=en_US">Lot 11391, Commercial Centre, Tabuan Heights, Jalan Song Kuching, Malaysia</a>
						<br>
						<br>
						<h5>Working Hours</h5>
						<div class="justify-content-center"></div>
						<center>
							<table class="m-0" cellpadding="8">
								<tr>
									<td>Monday</td>
									<th>1:00 PM - 8:30 PM</th>
								</tr>
								<tr>
									<td>Tuesday</td>
									<th>1:00 PM - 8:30 PM</th>
						...
						<br>
						<h5>Email</h5>
						<p><a href="mailto:nekonekonyaannn@gmail.com">nekonekonyaannn@gmail.com</a></p>
					</div>
				</div>
			</div>
		</div>
